...
<template>
  ...
  <UIContentArea class="border-b-2" :padding="'less'">
          ...
          <svg width="1060" height="742" version="1.1" viewBox="-2100 -1470 4200 2940" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
              ...
              <path id="O" d="m0 0a31.5 35 0 0 0 0-70 31.5 35 0 0 0 0 70m0-13a18.5 22 0 0 0 0-44 18.5 22 0 0 0 0 44"
                fill-rule="evenodd" />
              <path id="P" d="m-31.5 0h13v-26h28a22 22 0 0 0 0-44h-40zm13-39h27a9 9 0 0 0 0-18h-27z"
                fill-rule="evenodd" />
              <path id="S"
            ...
            <path d="m-2205 1470a1785 1785 0 0 1 3570 0h-105a1680 1680 0 1 0-3360 0z" clip-path="url(#band)"
              fill="#fff" />
